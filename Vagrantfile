...
web_docroot = vconfig['web_docroot']
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  if is_windows
    ...
    config.vm.synced_folder vconfig['aux_synced_folder'], web_docroot + "/vlad_aux", 
      type: "smb", 
      id: "vagrant-aux", 
    ...
    config.vm.synced_folder vconfig['host_synced_folder'], web_docroot + "/drupal", type: "nfs", create: true, id: "vagrant-webroot"

    # Setup auxiliary synced folder
    config.vm.synced_folder vconfig['aux_synced_folder'], web_docroot + "/vlad_aux", type: "nfs", create: true, id: "vagrant-aux"

  elsif synced_folder_type == 'rsync'

    # Setup synced folder for site files
    config.vm.synced_folder vconfig['host_synced_folder'], web_docroot + "/drupal", type: "rsync", create: true, id: "vagrant-webroot"

    # Setup auxiliary synced folder
    config.vm.synced_folder vconfig['aux_synced_folder'], web_docroot + "/vlad_aux", type: "rsync", create: true, id: "vagrant-aux"
